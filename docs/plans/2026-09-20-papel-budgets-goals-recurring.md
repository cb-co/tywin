...
- Density (measured on real data at 1280px, 2026-09-21): a budget line is about 131px without the prorated line and 157px with it (the 120px first estimate did not survive: three rows of controls per line, and the amount stays editable in place); a goal or recurring block is at most 140px.
